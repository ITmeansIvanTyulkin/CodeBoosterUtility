...
public class DeepSeekService {
    ...
    public String analyzeArchitecture(String structure) {
        String prompt = "Проанализируй структуру этого Java-проекта:\n" + structure + "\n\n" +
                ...
                "Ответь структурировано, на русском языке.";
        return sendMessage(prompt, "deepseek-chat");
    }
    ...
    /**
     * Анализ соответствия кода требованиям (задаче)
     * @param requirement текст требования/задачи
     * @param code код проекта для анализа
     * @return структурированный анализ соответствия
     */
    public String analyzeCompliance(String requirement, String code) {
        String prompt = """
            Ты QA-инженер. Проверь, соответствует ли код требованию.
            ...
            Оцени:
            1. Полнота реализации (что реализовано, что нет)
            2. Соответствие названий методов и переменных требованию
            3. Логические ошибки в реализации
            4. Отсутствующие проверки и валидацию
            
            Дай структурированный ответ на русском языке с процентами соответствия.
            """.formatted(requirement, code);
