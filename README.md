...
**AI-powered Java code analyzer** — интеллектуальный помощник для анализа Java-кода, генерации тестов, рефакторинга и поиска ошибок с использованием DeepSeek API.
