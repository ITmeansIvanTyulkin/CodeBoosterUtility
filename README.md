...
- [Команды](#команды)
- [Примеры](#примеры)
    - [Анализ требования](#пример-1-анализ-требования)
    - [Анализ задачи из файла](#пример-2-анализ-задачи-из-файла)
    - [Генерация тестов](#пример-3-генерация-тестов)
    - [Полный анализ проекта](#пример-4-полный-анализ-проекта)
...
|--------------------|--------------|
| QA проверка        | Автоматическая проверка, что код реализует все требования задачи |
| Code Review        | Быстрая оценка соответствия PR поставленной задаче |
| Документирование   | Создание отчётов о покрытии требований |
| Аттестация         | Проверка, что все пункты задачи выполнены |
